...
| <img src="assets/agentos.png" width="36" height="36" alt="AgentOS logo"> | AgentOS<br><sub>Local-First Agentic Trading AI Agent, Token-Efficient by Design</sub> | [@useAgentOS](https://x.com/useAgentOS) |
