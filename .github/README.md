...
| **Basics** - simple, immediately-runnable skills; shown by default | `basics` | 16 | `digest`, `token-movers`, `pr-review`, `you-web-search` |
...
<details>
<summary><strong>Full catalog (all 64 skills by pack)</strong></summary>
...
| **Basics** (`basics`, 16) | `action-converter`,`article`,`bd-radar`,`digest`,`executor-mcp`,`fetch-tweets`,`github-trending`,`glim-mcp`,`idea-forge`,`last30`,`pr-review`,`price-alert`,`token-movers`,`tx-explain`,`write-tweet`,`you-web-search` |
